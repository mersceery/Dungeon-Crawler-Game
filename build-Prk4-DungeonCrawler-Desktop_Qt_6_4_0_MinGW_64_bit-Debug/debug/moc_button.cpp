...
#include <memory>
#include "../../Prk4-DungeonCrawler/button.h"
...
Q_CONSTINIT static const qt_meta_stringdata_Button_t qt_meta_stringdata_Button = {
    {
        QT_MOC_LITERAL(0, 6),  // "Button"
        QT_MOC_LITERAL(7, 11),  // "clickButton"
        QT_MOC_LITERAL(19, 0),  // ""
        QT_MOC_LITERAL(20, 5),  // "input"
        QT_MOC_LITERAL(26, 13)   // "ButtonClicked"
    },
    "Button",
    "clickButton",
    "",
...
Q_CONSTINIT static const uint qt_meta_data_Button[] = {
...
void Button::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->clickButton((*reinterpret_cast< std::add_pointer_t<char>>(_a[1]))); break;
        ...
        {
            using _t = void (Button::*)(char );
            if (_t _q_method = &Button::clickButton; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void Button::clickButton(char _t1)
{
